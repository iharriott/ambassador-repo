...
__decorate([
    common_1.UseGuards(auth_guard_1.AuthGuard),
    common_1.Get('admin/products/:id'),
...
__decorate([
    common_1.UseGuards(auth_guard_1.AuthGuard),
    common_1.Put('admin/products/:id'),
...
__decorate([
    common_1.UseGuards(auth_guard_1.AuthGuard),
    common_1.Delete('admin/products/:id'),
    __param(0, common_1.Param('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
...
__decorate([
    common_1.CacheKey('products_frontend'),
    common_1.CacheTTL(30 * 60),
    common_1.UseInterceptors(common_1.CacheInterceptor),
    common_1.Get('ambassador/products/frontend'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ProductController.prototype, "frontend", null);
__decorate([
    common_1.Get('ambassador/products/backend'),
