...
let Order = class Order {
    ...
    get total() {
        var _a;
        return (_a = this.order_items) === null || _a === void 0 ? void 0 : _a.reduce((s, i) => s + i.admin_revenue, 0);
    }
    get ambassador_revenue() {
        var _a;
        return (_a = this.order_items) === null || _a === void 0 ? void 0 : _a.reduce((s, i) => s + i.ambassador_revenue, 0);
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Number),
    __metadata("design:paramtypes", [])
], Order.prototype, "ambassador_revenue", null);
__decorate([
    typeorm_1.OneToMany(() => order_item_1.OrderItem, orderItem => orderItem.order),
